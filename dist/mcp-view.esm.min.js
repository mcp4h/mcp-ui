async function p(r,n,e){try{if(r instanceof Response){if(!r.ok)return{ok:!1,mime:"text/plain",body:new Uint8Array,error:`HTTP ${r.status}`};let t=new Uint8Array(await r.arrayBuffer());return{ok:!0,mime:r.headers.get("content-type")||d(n,e),body:t}}if(r instanceof Blob){let t=new Uint8Array(await r.arrayBuffer());return{ok:!0,mime:r.type||d(n,e),body:t}}if(typeof r=="string"){let o=new TextEncoder().encode(r);return{ok:!0,mime:d(n,e),body:o}}if(r instanceof ArrayBuffer){let t=new Uint8Array(r);return{ok:!0,mime:d(n,e),body:t}}if(r instanceof Uint8Array)return{ok:!0,mime:d(n,e),body:r}}catch(t){return{ok:!1,mime:"text/plain",body:new Uint8Array,error:t instanceof Error?t.message:"Unknown error"}}return{ok:!1,mime:"text/plain",body:new Uint8Array,error:"Unsupported resolver result"}}function d(r,n){if(r==="document")return"text/html";if(r==="style")return"text/css";if(r==="script")return"text/javascript";let e=k(n);if(e){let t={css:"text/css",js:"text/javascript",mjs:"text/javascript",cjs:"text/javascript",json:"application/json",svg:"image/svg+xml",png:"image/png",jpg:"image/jpeg",jpeg:"image/jpeg",gif:"image/gif",webp:"image/webp",avif:"image/avif",woff:"font/woff",woff2:"font/woff2",ttf:"font/ttf",otf:"font/otf",mp3:"audio/mpeg",wav:"audio/wav",mp4:"video/mp4",webm:"video/webm"};if(t[e])return t[e]}return r==="img"?"image/png":"application/octet-stream"}function k(r){try{let t=new URL(r).pathname.split("/").pop();return!t||!t.includes(".")?null:t.split(".").pop()?.toLowerCase()||null}catch{return null}}function g(r,n={}){let e=E(r),t=n.autoHeight?"true":"false";return`(() => {
  const initialData = ${e};
